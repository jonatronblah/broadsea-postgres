...
ENV GITHUB_PAT=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 

RUN apt-get update && apt-get install -y python-dev openjdk-8-jdk liblzma-dev libbz2-dev r-cran-rjava r-cran-dbi \
&& R CMD javareconf
